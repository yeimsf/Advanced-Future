...
class Footer extends Component {
    ...
    render() {
        return (
            <div className="footer" style={{marginTop: "30px", bottom: 0, left: 0, right: 0 }}>
			...
			<div className="align-self-center text-center">
				<p className="align-self-center col-12">Developed By: <a href="https://github.com/Youssefanter">Youssef Anter</a> <a href="https://github.com/Yeimsf">Youssef Fakhry</a></p>
		    		<h5 className="align-self-center col-12">Advanced Future Real-Estate</h5>
			</div>
		    </div>
                </div>
            </div>
